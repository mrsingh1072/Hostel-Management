                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <small id="econtactError" class="text-danger" style="display:none;">Please enter a valid 10-digit emergency contact number.</small>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    // Add validation for Guardian's Contact Number
